...
|---|---|---|
| 1 | Project folder structure scaffolded | ✅ |
| 2 | FastAPI backend + PostgreSQL connection + `/health` endpoint | ✅ |
| 3 | Database schema: Users, Employee Profiles, Activity Logs | ✅ |
| 4 | React frontend scaffolded, connected to backend API | ✅ |
| 5 | JWT authentication + role-based access control (RBAC) | ✅ |
| 6 | Employee Profile CRUD (backend + frontend) | ✅ |
| 7 | Activity Log ingestion pipeline | ✅ |

**UI redesign:** the frontend has also been restyled with a dark, console-style theme suited to a security operations tool — sidebar navigation, live status indicator, role badges, and monospace data display for IDs/timestamps.
